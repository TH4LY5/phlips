package com.teste.thalys.thalys.service;
...
public class ClienteService implements ClienteServiceInterface{
	...
	public String cadastrarCliente(Cliente cliente){
		...
		Integer verificarCliente = 0;
		Boolean validarCpf = false;
		String status = "";
		
		verificarCliente = clienteRepository.verificarCPF(cliente.cpf);
		
		if(verificarCliente != 1) {
			
			validarCpf = ClienteService.isCPF(cliente.cpf);
